          ...
          <br></br><br></br>
            <div className="row">
              ...
              <div className="col-md-6">
                <h4>My Skills</h4>
                <br></br>
                <p>Front End: HTML, CSS, Bootstrap, Materialize, React, JavaScript, JQuery, Node.js, Express. Back End: Passport, RESTful APIs, relational and non-relational databases, such as MySQL and Sequelize, MongoDB and Mongoose, and client-side storage with IndexedDB API.</p>
