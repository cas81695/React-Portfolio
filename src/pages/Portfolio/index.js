...
import portfolio from "../../backgroundImages/portfolio.png"
    ...
    <div className="content section" id="portfolioSection">
      ...
      <p className="center padding-10">
        <em>Here are some of the projects I've done.
          Click on the images to view the deployed application or click on this
          <a className="githubInText" href="https://github.com/cas81695"> link </a>
